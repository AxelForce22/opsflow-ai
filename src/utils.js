...
// getProjectHealth delegates to the newer point-based scoring in biHelpers.js.
// It still returns { status, score, reasons, action } so all existing components work unchanged.
import { calculateProjectRisk } from "./bi/biHelpers.js";
export { calculateProjectRisk as getProjectHealth };
